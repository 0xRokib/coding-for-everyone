import { AlertCircle, ArrowRight, CheckCircle2, Loader2, Lock, Mail, Sparkles } from 'lucide-react';
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden bg-slate-900 border-r border-slate-800">
        ...
        <div className="relative z-10 max-w-md">
            <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
                Unlock your potential with <span className="text-brand-400">AI-powered</span> learning.
            </h2>
            <div className="space-y-4">
                <div className="flex items-center gap-3 text-slate-400">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400" />
                    <span>Personalized curriculum for your goals</span>
                </div>
                <div className="flex items-center gap-3 text-slate-400">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400" />
                    <span>Instant feedback from AI mentors</span>
                </div>
                <div className="flex items-center gap-3 text-slate-400">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400" />
                    <span>Build real projects, fast</span>
                </div>
            </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <a href="#" className="text-sm font-medium text-brand-400 hover:text-brand-300 transition-colors">Forgot password?</a>
                    </div>
                    <div className="relative group">
                        <input
                            type="password"

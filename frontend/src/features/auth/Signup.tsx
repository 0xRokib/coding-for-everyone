    ...
    return (
        <div className="min-h-screen w-full flex bg-slate-950 text-white font-sans selection:bg-brand-500/30">
            ...
            <nav className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-50">
                ...
                <button onClick={() => navigate('/login')} className="text-sm font-medium text-slate-400 hover:text-white transition-colors">
                    Already have an account? <span className="text-brand-400 hover:text-brand-300 ml-1">Sign in</span>
                </button>
            </nav>
